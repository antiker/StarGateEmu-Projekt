    ...
    public:
        ...
        bool OnGossipSelect(Player* player, GameObject* /*go*/, uint32 sender, uint32 action)
        {
            ...
            if (sender == GOSSIP_SENDER_PORT)
            {
                ...
                if (action==3)
                   player->TeleportTo(645,530.54f,863.57f,134.98,3.15f);
                if (action==4)
